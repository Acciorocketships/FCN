...
def Vgg16_weights(input_shape=(224,224,3),weights_path=None,classes=1):
...
def ResNet50_weights(input_shape=(224,224,3),weights_path=None,classes=1):
...
def Vgg19_weights(input_shape=(224,224,3),weights_path=None,classes=1):
