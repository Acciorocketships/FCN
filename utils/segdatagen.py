...
class SegDirectoryIterator(Iterator):
    ...
    def __init__(self, file_path, seg_data_generator,
                 ...
                 data_suffix='.jpg', label_suffix='.png', ignore_label=255,
                 crop_mode='none', label_cval=0, pad_size=None,
...
class SegDataGenerator(object):
    ...
    def flow_from_directory(self, data_dir, label_dir, file_path, classes, 
        ...
        return SegDirectoryIterator(
            ...
            data_suffix=data_suffix, label_suffix=label_suffix, ignore_label=ignore_label,
